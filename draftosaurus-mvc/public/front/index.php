...
$sessionUser = $sessionUser ?? ($_SESSION['user'] ?? null);
$email = $sessionUser['email'] ?? '';
$userRole = strtolower(trim($sessionUser['role'] ?? 'player'));
$initialScreen = $initialScreen ?? ($_GET['screen'] ?? 'home');
?>
...
<body data-initial-screen="<?php echo htmlspecialchars($initialScreen, ENT_QUOTES, 'UTF-8'); ?>">
    <div class="container">
                ...
                <div class="account-subsection-row">
                    ...
                    <?php if ($email): ?>
                        ...
                        <?php if ($userId): ?>
                            ...
                            <div class="profile">
                                <h2>¡Bienvenido/a, <?php echo htmlspecialchars($user['name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>!</h2>
                                ...
                                <form action="/account/update" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="date" id="birthday" value="<?php echo htmlspecialchars($user['birthday'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" disabled>
                                ...
                                <form id="delete-account-form" action="/account/delete" method="POST" style="display:none;"></form>
                                ...
                                <a class="button" href="/auth/logout">Cerrar sesión</a>
                            </div>
                            <div class="result">
                            ...
                            <?php if ($userRole === 'admin'): ?>
                                ...
                                <a class="button admin-logout" href="/auth/logout">Cerrar sesión</a>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="registration">
                                <p style="color: black;">No se pudo recuperar la información de tu perfil.</p>
                            </div>
                        <?php endif; ?>
